...
| 01 | [bondy_oplog](01_bondy_oplog.md) | The write side: instances, WAL (disk and in-memory), fused mode, the leaderless sync sessions (over Partisan), and the per-round freshness heartbeat. |
