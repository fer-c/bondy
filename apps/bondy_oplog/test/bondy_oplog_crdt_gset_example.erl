...
%% `bondy_oplog_fold` family. Production CRDTs are migrated under the
%% rollout (`architecture_regrounding_plan.md` §7); this stays in `test/`
%% as the contract's executable specification.
%%
