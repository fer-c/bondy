...
-moduledoc """
Builds and validates the `Options` dictionary of WAMP messages such as
`CALL`, `PUBLISH`, `SUBSCRIBE`, `REGISTER`, `CANCEL`, `INTERRUPT` and `YIELD`,
honouring the extended options configured in the application environment.
""".
