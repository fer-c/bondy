...
-define(BONDY_CERT_GET_SERVER_CERT_INFO,
    <<"bondy.cert_manager.get_server_cert_info">>
).
...
-define(BONDY_OAUTH2_RES_OWNER_DELETE,
    <<"bondy.oauth2.resource_owner.delete">>
).
...
-define(BONDY_OAUTH2_RES_OWNER_UPDATE,
    <<"bondy.oauth2.resource_owner.update">>
).
...
-define(BONDY_OAUTH2_RES_OWNER_DELETED,
    <<"bondy.oauth2.resource_owner.deleted">>
).
-define(BONDY_OAUTH2_RES_OWNER_UPDATED,
    <<"bondy.oauth2.resource_owner.updated">>
).
...
-define(BONDY_ERROR_HTTP_API_GATEWAY_INVALID_EXPR,
...
-define(BONDY_OAUTH2_CLIENT_DELETED_OLD,
    <<"bondy.api_gateway.client_deleted">>
).
-define(BONDY_OAUTH2_RES_OWNER_ADDED_OLD,
    <<"bondy.api_gateway.resource_owner_added">>
).
-define(BONDY_OAUTH2_RES_OWNER_DELETED_OLD,
...
-define(BONDY_USER_CREDENTIALS_CHANGED_OLD,
