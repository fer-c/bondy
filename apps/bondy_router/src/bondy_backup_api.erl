...
-moduledoc """
Implements the `bondy_wamp_api` behaviour for the Bondy backup administrative
procedures, dispatching WAMP calls to create, query the status of, and restore
backups via `m:bondy_backup`.
""".
